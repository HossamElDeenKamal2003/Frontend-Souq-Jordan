<template>
  ...
  export default {
    name: "personalAccessoriesList",
    data() {
      return {
        furnitureTypes: ConstVariables.personalAccessoriesList, // List of furniture types
        selectedFurnitureType: null, // Track the selected furniture type (renamed for clarity)
      };
    },
    methods: {
